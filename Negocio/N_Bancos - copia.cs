...
namespace Logica
{
 ...
 {
     M_Bancos C_Bancos = new M_Bancos();
     ...
     public long Nuevo(M_Bancos Bancos)
     {
         ...
         //Parametros.Add("Cod_banco", Bancos.Cod_banco);
         //   Parametros.Add("Nombre_banco", Bancos.Nombre_banco);
         //   Parametros.Add("Cod_empresa", Bancos.Cod_empresa);
         //   Parametros.Add("No_id", Bancos.No_id);
         //   Parametros.Add("Dv", Bancos.Dv);
