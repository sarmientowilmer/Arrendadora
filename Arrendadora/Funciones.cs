...
namespace Arrendadora
{
    class Funciones
    {
        ...
        public void IniciarAccess()
        {
            N_General General = new N_General();
            //General.DatosServidoryPath(Program.GsPath);
            if (Program.GsPathData == "") General.DatosServidoryPath(Program.GsPath);
            Program.GsPathData = General.GsPath;
        }

        public void CargarCombo(ref ComboBox combo, DataTable DS, string CampoDescripcion, string CampoID)
        {
